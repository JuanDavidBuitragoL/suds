...
class crearProduDAO {
    static crearProducto(sqlConfirmar, sqlCrear, params, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield conexion_1.default
                ...
                if (respuesta.id_producto != 0) {
                    ...
                    res.status(400).json({
                        Mensaje: "Producto no creado, puede estar repetido",
                    });
                }
            })
                .catch((mierror) => {
...
exports.default = crearProduDAO;
//# sourceMappingURL=crearProduDAO.js.map