...
class listarUsuDAO {
    ...
    static consulta16(sql_listar, parametros, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield conexion_1.default
                .result(sql_listar, parametros)
                .then((respuesta) => {
                ...
                return res
                    .status(200)
                    .json({ Mensaje: "Cantidad de usuarios: ", Respuesta: respuesta.rows });
            })
                .catch((errorcito) => {
                console.log("Exploto D:...", errorcito);
                res.status(400).json({
                    Mensaje: "Error contando usuarios, comunique al admin pro",
                });
            });
        });
    }
}
exports.default = listarUsuDAO;
//# sourceMappingURL=listarUsuDAO.js.map